...
def check_imports(source_name):
    ...
    with open('bayes_classifier.py',"r") as f:
...
class NaiveBayesTest(unittest.TestCase):
    ...
    def test1(self):
        ...
        # Training data on first 12478 movie reviews
        classifier.train(data[:12478])

        # Classifying the rest of the reviews
        # based on the probabilities of the trained data 
